class User < ActiveRecord::Base
    ...
    def payment_success(event)
        ...
        self.user_payments.first.payment_history = self.user_payments.first.payment_history.push({"amount" => event.data.object.lines.data[0].amount, "date" => event.data.object.date, "type" => event.type, "start" => event.data.object.period_start, "end" => event.data.object.period_end})
